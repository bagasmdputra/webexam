...
<div class="block-wrap">
    ...
    <div class="price-block">
        <h4>FREE</h4>
        <div class="price">
            <sup>$</sup><strong>0</strong><em>/ mo</em>
            <p class="desc"><strong>Billed annually</strong> or <br>$0 billed monthly</p>
        </div>
        <div class="fee">
            <strong>1</strong><em>%</em>
            <p class="desc">
                <strong>Transaction Fee</strong><br>
                <small>+ <a href="https://help.plasso.com/why-is-there-an-additional-merchant-fee/">Merchant Fees</a></small>
            </p>
        </div>
        <div class="revenue">
            <p class="desc">
                <strong>Unlimited Revenue</strong>
            </p>
        </div>
        <div class="cta">
            <a class="btn" data-modal-id="#riyo-signup-form" href="#">Start Exam</a>
        </div>
    </div>
    ...
    <div class="price-block">
        <h4>BASIC</h4>
        <div class="price">
            <sup>$</sup><strong>41</strong><em>/ mo</em>
            <p class="desc"><strong>Billed annually</strong> or <br>$49 billed monthly</p>
        </div>
        <div class="fee">
            <strong>1</strong><em>%</em>
            <p class="desc">
